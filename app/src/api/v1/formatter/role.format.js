...
exports.customRoleFormater = (permissions = {}) => {
    const { seller = null, customer = null, partner = null, employ = null, outlet = null, product = null, category = null, cusine = null, transaction = null, order = null, role = null, manager = null } = permissions
    return {
        seller: {
        ...
        role: {
            view: role?.view ? role.view : false,
            edit: role?.edit ? role.edit : false,
            add: role?.add ? role.add : false,
            delete: role?.delete ? role.delete : false,
        },
        manager: {
            view: manager?.view ? manager.view : false,
            edit: manager?.edit ? manager.edit : false,
            add: manager?.add ? manager.add : false,
            delete: manager?.delete ? manager.delete : false,
        },
    }
}
//--------------------------------------edit-role---------------------------------------------------------------//
